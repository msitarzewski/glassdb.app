...
| 2026-08-09 | Phase 08.1/08.8 schema and package decision | settle endpoint ownership before CloudKit implementation | version-one non-secret `EndpointProfile` and overlay migration boundaries approved; `GlassConnectionKit` published and pinned after exhaustive reuse analysis; C3 migration/sync implementation remains open | glas.sh `08-glassdb-metadata-sync.md`; `GlassConnectionKit@0ced944`; glassdb `decisions.md` 2026-08-09 |
